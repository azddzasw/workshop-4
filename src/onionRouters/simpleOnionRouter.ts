...
export function setLastReceivedEncryptedMessage(message: string) {
  lastReceivedEncryptedMessage = message;
}

export function setLastReceivedDecryptedMessage(message: string) {
  lastReceivedDecryptedMessage = message;
}

export function setLastMessageDestination(destination: number) {
